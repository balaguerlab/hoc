function [total_correct_pos,total_correct_neg,total_incorrect_pos,total_incorrect_neg]=...
    basicStatsCorrelSign_alt(file_corr_basic,file_incorr_basic,location,period,plotTitle)
%Alternative to basicStatsCorrelSign which aggregates in time bins
...
[correct_blocks_noisecorrel,pname,bins_vector]=get_period(correct_blocks_noisecorrel,period);
...
all_correct_neg=nanmean(nanmean(abs(matrix_correct_neg),1));%allmed for all time bins of the period
%all_correct_neg=nansum(nansum(abs(matrix_correct_neg),1));%allmed for all time bins of the period
total_correct_neg=nanmean(abs(matrix_correct_neg),1);%Averaged for all time bins of the period
%total_correct_neg=nansum(abs(matrix_correct_neg),1);%Averaged for all time bins of the period
mean_correct_neg=nanmean(total_correct_neg);
error_bar_correct_neg=nanstd(total_correct_neg)/sqrt(length(total_correct_neg));

all_correct_pos=nanmean(nanmean(abs(matrix_correct_pos),1));%allmed for all time bins of the period
%all_correct_pos=nansum(nansum(abs(matrix_correct_pos),1));%allmed for all time bins of the period
total_correct_pos=nanmean(abs(matrix_correct_pos),1);%Averaged for all time bins of the period
%total_correct_pos=nansum(abs(matrix_correct_pos),1);%Averaged for all time bins of the period
mean_correct_pos=nanmean(total_correct_pos);
error_bar_correct_pos=nanstd(total_correct_pos)/sqrt(length(total_correct_pos));

 total_correct_abs=nanmean(abs(matrix_correct_abs),1);%Averaged for all time bins of the period
...
all_incorrect_neg=nanmean(nanmean(abs(matrix_incorrect_neg),1));%Summed for all time bins of the period
%all_incorrect_neg=nansum(nansum(abs(matrix_incorrect_neg),1));%Summed for all time bins of the period
total_incorrect_neg=nanmean(abs(matrix_incorrect_neg),1);%Averaged for all time bins of the period
%total_incorrect_neg=nansum(abs(matrix_incorrect_neg),1);%Averaged for all time bins of the period
...
all_incorrect_pos=nanmean(nanmean(abs(matrix_incorrect_pos),1));%Summed for all time bins of the period
%all_incorrect_pos=nansum(nansum(abs(matrix_incorrect_pos),1));%Summed for all time bins of the period
%total_incorrect_pos=nansum(abs(matrix_incorrect_pos),1);%Averaged for all time bins of the period
total_incorrect_pos=nanmean(abs(matrix_incorrect_pos),1);%Averaged for all time bins of the period
...
error_bar_incorrect_pos=nanstd(total_incorrect_pos)/sqrt(length(total_incorrect_pos));
 ...
 total_incorrect_abs=nanmean(abs(matrix_incorrect_abs),1);%Averaged for all time bins of the period
